...
def import_transcripts(config_file: Path) -> None:
    """
    Walks through the transcripts folder and imports the transcripts into the database.
    ...
    study = config_params["study"]

    subjects_root = data_root / "PROTECTED" / study

    transcripts = list(
        subjects_root.glob("*/offsite_interview/processed/transcripts/*.txt")
    )
...
if __name__ == "__main__":
    ...
    import_transcripts(config_file)
