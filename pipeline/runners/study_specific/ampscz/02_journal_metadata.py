...
from pipeline.helpers import cli, ffprobe, utils, db

MODULE_NAME = "pipeline.runners.ampscz.journal_metadata"
    ...
    while True:
        ...
        with utils.get_progress_bar() as progress:
            ...
            metadata_dict = ffprobe.get_metadata(
                file_path_to_process=Path(file_to_process), config_file=None
            )
