...
def get_anonymized_pdf(interview_name: str, config_file: Path) -> List[Path]:
    """
    Returns the paths to the anonymized pdfs generated by the pipeline for the given interview.
